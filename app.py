...
class User(db.Model):
    ...
    subject = db.Column(db.String(50)) # NEW
...
# NEW: All questions grouped by subject
ALL_QUESTIONS = {
...
<form method="POST">
    ...
    <select name="subject" required> <!-- NEW DROPDOWN -->
...
def home():
    ...
    if request.method == "POST":
        ...
        user = User.query.filter_by(name=name, subject=subject).first() # 1 attempt per subject
...
def admin_panel():
    ...
    return render_template_string(ADMIN_TEMPLATE, attempts=attempts)
