...
ALL_QUESTIONS = {
    "Mathematics": [("Convert 1011_2 to base 10", "A. 9\nB. 10\nC. 11\nD. 12", "c"),("If 2x + 5 = 15, find x", "A. 4\nB. 5\nC. 6\nD. 10", "b"),("Find the LCM of 12 and 18", "A. 24\nB. 36\nC. 48\nD. 72", "b"),("Express 0.00045 in standard form", "A. 4.5 x 10^-3\nB. 4.5 x 10^-4\nC. 4.5 x 10^-5\nD. 45 x 10^-4", "b"),("What is 15% of 200?", "A. 20\nB. 25\nC. 30\nD. 35", "c"),("If a : b = 3 : 5 and b = 20, find a", "A. 8\nB. 10\nC. 12\nD. 15", "c"),("Simplify: 2/3 + 1/6", "A. 1/2\nB. 3/9\nC. 5/6\nD. 2/9", "c"),("Find the simple interest on N5000 for 2 years at 4%", "A. N200\nB. N400\nC. N500\nD. N800", "b"),("What is the square root of 169?", "A. 12\nB. 13\nC. 14\nD. 15", "b"),("If x = 3, evaluate x^2 + 2x - 5", "A. 5\nB. 8\nC. 10\nD. 15", "c")],
    "English": [("Choose the word nearest in meaning: 'Diligent'", "A. Lazy\nB. Hardworking\nC. Careless\nD. Weak", "b"),("Antonym of 'Generous'", "A. Kind\nB. Stingy\nC. Rich\nD. Poor", "b"),("Select the correct spelling", "A. Embarass\nB. Embarrass\nC. Embarras\nD. Embbarass", "b"),("'She sings ___ than her sister'", "A. good\nB. better\nC. best\nD. well", "b"),("The plural of 'Analysis'", "A. Analysiss\nB. Analyses\nC. Analysises\nD. Analysi", "b"),("Choose the correct tense: 'I ___ to Lagos yesterday'", "A. go\nB. goes\nC. went\nD. gone", "c"),("'Neither John nor Mary ___ present'", "A. are\nB. were\nC. is\nD. be", "c"),("Identify the figure of speech: 'A deafening silence'", "A. Simile\nB. Oxymoron\nC. Metaphor\nD. Irony", "b"),("What type of sentence is: 'If you study, you will pass'", "A. Simple\nB. Compound\nC. Complex\nD. Compound-Complex", "c"),("Synonym of 'Vast'", "A. Small\nB. Tiny\nC. Huge\nD. Narrow", "c")],
    "Physics": [("SI unit of length", "A. Meter\nB. Centimeter\nC. Kilometer\nD. Millimeter", "a"),("Instrument used to measure mass", "A. Spring balance\nB. Beam balance\nC. Meter rule\nD. Thermometer", "b"),("1 hour = ___ seconds", "A. 3600\nB. 1800\nC. 7200\nD. 60", "a"),("Which is a scalar quantity?", "A. Force\nB. Velocity\nC. Speed\nD. Acceleration", "c"),("The area under velocity-time graph gives", "A. Acceleration\nB. Force\nC. Distance\nD. Speed", "c"),("Dimension of force", "A. MLT^-1\nB. MLT^-2\nC. ML^2T^-2\nD. ML^-1T^-2", "b"),("Error due to faulty instrument is called", "A. Random error\nB. Systematic error\nC. Human error\nD. Zero error", "b"),("1 light year is a unit of", "A. Time\nB. Mass\nC. Distance\nD. Speed", "c"),("The S.I unit of time", "A. Minute\nB. Hour\nC. Second\nD. Day", "c"),("Which is not a fundamental quantity?", "A. Length\nB. Mass\nC. Area\nD. Temperature", "c")],
    "Chemistry": [("Method used to separate salt from water", "A. Filtration\nB. Evaporation\nC. Distillation\nD. Chromatography", "b"),("Which mixture can be separated by magnetism?", "A. Sand and salt\nB. Iron and sulfur\nC. Oil and water\nD. Alcohol and water", "b"),("Process of separating components of ink", "A. Crystallization\nB. Sublimation\nC. Chromatography\nD. Decantation", "c"),("Separating petrol from crude oil uses", "A. Fractional distillation\nB. Simple distillation\nC. Filtration\nD. Sieving", "a"),("Which is a chemical method of separation?", "A. Sieving\nB. Magnetism\nC. Precipitation\nD. Decantation", "c"),("Separating immiscible liquids uses", "A. Funnel\nB. Separating funnel\nC. Filter paper\nD. Sieve", "b"),("Sublimation is used for", "A. Salt and water\nB. Iodine and sand\nC. Oil and water\nD. Sugar and sand", "b"),("Purest form of water is obtained by", "A. Boiling\nB. Filtration\nC. Distillation\nD. Chlorination", "c"),("Which technique separates dye from cloth?", "A. Extraction\nB. Chromatography\nC. Evaporation\nD. Filtration", "b"),("Separating grain from chaff is called", "A. Winnowing\nB. Sieving\nC. Threshing\nD. Picking", "a")],
    "Biology": [("Powerhouse of the cell", "A. Nucleus\nB. Mitochondria\nC. Ribosome\nD. Vacuole", "b"),("Cell organelle that contains chlorophyll", "A. Mitochondria\nB. Chloroplast\nC. Lysosome\nD. Golgi body", "b"),("Which is not found in plant cell?", "A. Cell wall\nB. Centriole\nC. Chloroplast\nD. Large vacuole", "b"),("DNA is found in the", "A. Cytoplasm\nB. Nucleus\nC. Cell membrane\nD. Vacuole", "b"),("Function of ribosome", "A. Respiration\nB. Protein synthesis\nC. Digestion\nD. Storage", "b"),("The smallest unit of life", "A. Tissue\nB. Organ\nC. Cell\nD. Organelle", "c"),("Which cell has no nucleus?", "A. Nerve cell\nB. Red blood cell\nC. White blood cell\nD. Muscle cell", "b"),("Cell membrane is made of", "A. Cellulose\nB. Lipid and protein\nC. Chitin\nD. Starch", "b"),("Organelle for digestion", "A. Lysosome\nB. Peroxisome\nC. Vacuole\nD. Plastid", "a"),("Plant cells are rigid due to", "A. Cell membrane\nB. Cell wall\nC. Cytoplasm\nD. Nucleus", "b")],
    "Government": [("Power that is legally recognized is called", "A. Influence\nB. Authority\nC. Coercion\nD. Force", "b"),("The process of making and enforcing laws is", "A. Politics\nB. Government\nC. Democracy\nD. Administration", "b"),("Sovereignty means", "A. Rule of law\nB. Supreme power\nC. Separation of powers\nD. Fundamental rights", "b"),("A system where people elect representatives is", "A. Direct democracy\nB. Indirect democracy\nC. Monarchy\nD. Oligarchy", "b"),("The first political party in Nigeria was", "A. NCNC\nB. NNDP\nC. AG\nD. NPC", "b"),("Fundamental human rights are contained in Chapter ___", "A. II\nB. III\nC. IV\nD. V", "c"),("Pressure groups aim to", "A. Win elections\nB. Influence government\nC. Make laws\nD. Judge cases", "b"),("Arms of government are ___", "A. 2\nB. 3\nC. 4\nD. 5", "b"),("Citizenship by birth is called", "A. Naturalization\nB. Registration\nC. Jus soli\nD. Honorary", "c"),("The 1999 constitution is ___ constitution", "A. Parliamentary\nB. Presidential\nC. Monarchical\nD. Military", "b")],
    "Economics": [("The central problem of economics is", "A. Inflation\nB. Scarcity\nC. Unemployment\nD. Poverty", "b"),("Opportunity cost is", "A. Total cost\nB. Next best alternative forgone\nC. Money cost\nD. Fixed cost", "b"),("Land as a factor of production is rewarded with", "A. Wages\nB. Interest\nC. Rent\nD. Profit", "c"),("A want that can be satisfied is called", "A. Need\nB. Effective demand\nC. Human want\nD. Commodity", "b"),("The reward for entrepreneurship is", "A. Salary\nB. Interest\nC. Profit\nD. Dividend", "c"),("Goods used for further production are", "A. Consumer goods\nB. Capital goods\nC. Free goods\nD. Inferior goods", "b"),("The study of individual units is", "A. Macroeconomics\nB. Microeconomics\nC. Econometrics\nD. Statistics", "b"),("What you give up to get something else", "A. Price\nB. Cost\nC. Opportunity cost\nD. Budget", "c"),("Basic economic problem arises due to", "A. Unlimited resources\nB. Unlimited wants\nC. Limited wants\nD. Government policy", "b"),("Utility means", "A. Price\nB. Satisfaction\nC. Cost\nD. Demand", "b")],
    "Literature": [("Oral literature is passed down by", "A. Writing\nB. Printing\nC. Word of mouth\nD. Recording", "c"),("A short story with a moral lesson is", "A. Epic\nB. Ballad\nC. Fable\nD. Ode", "c"),("Heroic poem that tells of a hero's deeds", "A. Sonnet\nB. Epic\nC. Elegy\nD. Lyric", "b"),("Proverbs are examples of", "A. Drama\nB. Poetry\nC. Oral literature\nD. Novel", "c"),("A story told to explain natural phenomena", "A. Myth\nB. Legend\nC. Fable\nD. Ballad", "a"),("Chants used in worship are called", "A. Ballads\nB. Incantations\nC. Epics\nD. Tales", "b"),("Oral poetry with rhythmic repetition", "A. Sonnet\nB. Dirge\nC. Chant\nD. Ode", "c"),("Story about the past with some truth", "A. Myth\nB. Legend\nC. Fable\nD. Joke", "b"),("Praise song for a king", "A. Dirge\nB. Panegyric\nC. Elegy\nD. Ballad", "b"),("Riddles test one's", "A. Strength\nB. Wisdom\nC. Beauty\nD. Speed", "b")],
    "CRS": [("Who created man?", "A. Angel\nB. God\nC. Adam\nD. Moses", "b"),("The first man and woman were", "A. Cain and Abel\nB. Abraham and Sarah\nC. Adam and Eve\nD. Isaac and Rebecca", "c"),("Man was created in the ___ of God", "A. Likeness\nB. Image\nC. Shadow\nD. Form", "b"),("The garden where Adam and Eve lived", "A. Gethsemane\nB. Eden\nC. Sinai\nD. Zion", "b"),("Who tempted Eve?", "A. Cain\nB. Serpent\nC. Angel\nD. God", "b"),("The consequence of sin was", "A. Blessing\nB. Death\nC. Wealth\nD. Joy", "b"),("God provided clothes made of", "A. Cotton\nB. Linen\nC. Animal skin\nD. Leaves", "c"),("Who was the first child of Adam and Eve?", "A. Seth\nB. Cain\nC. Abel\nD. Noah", "b"),("God rested on the ___ day", "A. 6th\nB. 7th\nC. 1st\nD. 3rd", "b"),("The tree in the middle of Eden was", "A. Tree of life\nB. Tree of knowledge\nC. Apple tree\nD. Fig tree", "b")]
}
